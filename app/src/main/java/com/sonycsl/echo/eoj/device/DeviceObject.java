...
public abstract class DeviceObject extends EchoObject {
    ...
    protected boolean isValidOperationStatus(byte[] edt) {
        ...
        if (edt[0] != EDT_OPERATION_STATUS_ON[0] && edt[0] != EDT_OPERATION_STATUS_OFF[0]) {
            return false;
        }
        return true;
    }
    ...
    /**
     * This property indicates the version number of the corresponding
     * standard.<br>
     * <br>
     ...
     * 0x01－0xFD：This is a communication protocol used in the lower-layer
     * communication and is set arbitrarily according to the protocol class in
     * the case where unique number is assigned (not used in ECHONET Lite).<br>
     ...
     * 0xFE：2－17 bytes are defined by the manufacturer, and are set according to
     * the type.<br>
     * 0xFF：2－9 bytes are defined when randomly generated protocol is used in
     * the lower-layer communication.<br>
    ...
    protected boolean isValidIdentificationNumber(byte[] edt) {
        if (edt == null || !(edt.length == 9 || edt.length == 17)) {
            return false;
        }
        return true;
    }
    ...
    /**
     * This property indicates the instantaneous power consumption of the device
     * in watts.<br>
     * <br>
    ...
    /**
     * This property indicates the cumulative power consumption of the device in
    ...
    /**
     * This property indicates whether a fault (e.g. a sensor trouble) has
     * occurred or not.<br>
     * <br>
     ...
     * <br>
     * This property indicates the product ion date in the YYMD format (1
     * character = 1 byte) .<br>
    ...
    /**
     * This property indicates whether the device is operating in power-saving
     * mode.<br>
     * <br>
    ...
    /**
     * This property indicates whether remote control is through a public
     * network or not.<br>
     * <br>
    ...
    /**
     * This property indicates the cumulative number of days, hours, minutes or
     * seconds for which the device has operated, using 1 byte for the unit and
     * 4 bytes for the time.<br>
     * <br>
     * First byte: Indicates the unit.<br>
     * Second： 0x41; Minute： 0x42; Hour： 0x43; Day:0x44<br>
     * Second to fifth bytes ：<br>
     * Indicates the elapsed time in the unit specified by the first byte.
     * 0x00000000-0xFFFFFFFF (0-4294967295)<br>
     * <br>
    ...
    public static class Receiver extends EchoObject.Receiver {
         ...
         * First byte: lower-layer communication ID field<br>
         * 0x01－0xFD：This is a communication protocol used in the lower-layer
         * communication and is set arbitrarily according to the protocol class
         * in the case where unique number is assigned (not used in ECHONET
         * Lite).<br>
         * 0x11－0x1F: Power line Communication Protocol A and B systems<br>
         * 0x31-0x3F: Designated low-powor radio<br>
         * 0x41-0x4F: Extended HBS<br>
         ...
         * 0xA1: Power line Communication Protocol C systems<br>
         * 0xB2：IPv6/6LoWPAN<br>
         * 0xFE：2－17 bytes are defined by the manufacturer, and are set
         * according to the type.<br>
         * 0xFF：2－9 bytes are defined when randomly generated protocol is used
         * in the lower-layer communication.<br>
         * 0x00：Identification number is not set.<br>
        ...
        /**
         * This property indicates the instantaneous power consumption of the
         * device in watts.<br>
        ...
        /**
         * This property indicates the cumulative power consumption of the
         * device in increments of 0.001kWh.<br>
         ...
         * First byte: Indicates the data size of the fault code field.<br>
         * Second to fourth bytes: Manufacturer code<br>
         * Fifth and succeeding bytes: Field for manufacturer-defined fault
         * code<br><br>
         * Data Type : unsigned char×(MAX)225<br>
         * Data Size(Byte) : Max 225<br>
         * Set : undefined<br>
        ...
        /**
         * This property indicates whether the device is operating in
        ...
        /**
         * Current date (YYYY：MM：DD format)<br>
         * 1 ～ 0x270F ： 1 ～ 0x0C ： 1 ～ 0x1F (=1 ～ 9999) ： (=1 ～ 12) ： (=1 ～
         * 31)<br><br>
         * Data Type : unsigned char×4<br>
         * Data Size(Byte) : 4<br>
         * Set : optional<br>
        ...
        /**
         * This property indicates the cumulative number of days, hours, minutes
         * or seconds for which the device has operated, using 1 byte for the
         * unit and 4 bytes for the time.<br>
         * First byte: Indicates the unit.<br>
         * Second： 0x41; Minute： 0x42; Hour： 0x43; Day:0x44<br>
         * Second to fifth bytes ：<br>
         * Indicates the elapsed time in the unit specified by the first byte.
         * 0x00000000-0xFFFFFFFF (0-4294967295)<br><br>
         * Data Type : unsigned char + unsigned long<br>
         * Data Size(Byte) : 1+4 Byte<br>
         * Set : undefined<br>
         * Get : optional
