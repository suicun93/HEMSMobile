...
public abstract class Television extends DeviceObject {
     ...
     * Refer to the section on the requirements for the display class (class
     * group code = 0x06, class code<br>
     * = 0x01).<br>
     * <br>
     ...
     * Get - optional<br>
     */
    protected boolean setDisplayControlSetting(byte[] edt) {
        return false;
    }
     ...
     * Get - optional<br>
     */
    protected byte[] getDisplayControlSetting() {
        return null;
    }
     ...
     * <br>
     * <br>
     * Data type : unsigned char× Max 247<br>
     * <br>
     ...
     * Get - optional<br>
     */
    protected byte[] getCharacterStringToPresentToTheUser() {
        return null;
    }
    ...
    protected synchronized boolean setProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_DISPLAY_CONTROL_SETTING:
                return setDisplayControlSetting(property.edt);
            case EPC_CHARACTER_STRING_TO_PRESENT_TO_THE_USER:
                return setCharacterStringToPresentToTheUser(property.edt);
            default:
                return false;
        }
    }
    ...
    protected synchronized byte[] getProperty(byte epc) {
        ...
        switch (epc) {
            case EPC_DISPLAY_CONTROL_SETTING:
                return getDisplayControlSetting();
            case EPC_CHARACTER_STRING_SETTING_ACCEPTANCE_STATUS:
                return getCharacterStringSettingAcceptanceStatus();
            case EPC_SUPPORTED_CHARACTER_CODES:
                return getSupportedCharacterCodes();
            case EPC_CHARACTER_STRING_TO_PRESENT_TO_THE_USER:
                return getCharacterStringToPresentToTheUser();
            case EPC_LENGTH_OF_CHARACTER_STRING_ACCEPTED:
                return getLengthOfCharacterStringAccepted();
            default:
                return null;
        }
    }
    ...
    protected synchronized boolean isValidProperty(EchoProperty property) {
        ...
        switch (property.epc) {
            case EPC_DISPLAY_CONTROL_SETTING:
                return isValidDisplayControlSetting(property.edt);
            case EPC_CHARACTER_STRING_SETTING_ACCEPTANCE_STATUS:
                return isValidCharacterStringSettingAcceptanceStatus(property.edt);
            case EPC_SUPPORTED_CHARACTER_CODES:
                return isValidSupportedCharacterCodes(property.edt);
            case EPC_CHARACTER_STRING_TO_PRESENT_TO_THE_USER:
                return isValidCharacterStringToPresentToTheUser(property.edt);
            case EPC_LENGTH_OF_CHARACTER_STRING_ACCEPTED:
                return isValidLengthOfCharacterStringAccepted(property.edt);
            default:
                return false;
        }
    }
    ...
    public static class Proxy extends Television {
        ...
        @Override
        protected byte[] getCharacterStringSettingAcceptanceStatus() {
            return null;
        }

        @Override
        protected byte[] getSupportedCharacterCodes() {
            return null;
        }

        @Override
        protected boolean setCharacterStringToPresentToTheUser(byte[] edt) {
            return false;
        }

        @Override
        protected byte[] getLengthOfCharacterStringAccepted() {
            return null;
        }
    }
